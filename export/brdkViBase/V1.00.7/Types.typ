...
TYPE
	brdkViBase_hmi_blob_in_typ : 	STRUCT  (*BLOB hardware structure for a result*)
		...
		xMin : REAL; (* Extreme value in the column direction
Minimum column position of the BLOB area, In 1/100 pixel steps*)
		xMax : REAL; (*Extreme value in the column direction
Maximum column position of the BLOB area, In 1/100 pixel steps*)
		yMin : REAL; (*Extreme value in the line direction
Minimum line position of the BLOB area, In 1/100 pixel steps*)
		yMax : REAL; (*Extreme value in the line direction
Maximum line position of the BLOB area, In 1/100 pixel steps*)
