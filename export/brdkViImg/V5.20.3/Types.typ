...
TYPE
	...
	END_STRUCT;
	brdkViImg_WsChannelInternal_typ : 	STRUCT 
		receiver : TcpRecv;
		sender : TcpSend;
		closer : TcpClose;
	...
	brdkViImg_mappViewInfo_typ : 	STRUCT  (*Information used by mappView.*)
		heartbeat : UDINT; (*Count of the asynchronious thread running.*)
	...
	END_STRUCT;
	brdkViImg_WsServerInternal_typ : 	STRUCT 
		tcpOpen : TcpOpen;
		tcpServer : TcpServer;
		tcpIoctl : TcpIoctl;
		tcpRecieve : TcpRecv;
