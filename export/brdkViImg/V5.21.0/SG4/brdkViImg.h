...
#define _brdkViImg_VERSION 5.21.0
#endif
...
/* Constants */
 ...
 #define ERR_BRDKVIIMG_SRC_LEN_IS_ZERO 64011U
 #define ERR_BRDKVIIMG_JPG_ENCODING_ERR 64010U
 #define ERR_BRDKVIIMG_JPG_DECODING_ERR 64009U
 #define ERR_BRDKVIIMG_MAX_LEN_IS_ZERO 64008U
 #define ERR_BRDKVIIMG_PSRC_IS_ZERO 64007U
 #define ERR_BRDKVIIMG_CHANNELS_IS_ZERO 64006U
 #define ERR_BRDKVIIMG_HEIGHT_IS_ZERO 64005U
 #define ERR_BRDKVIIMG_WIDHT_IS_ZERO 64004U
 ...
 _GLOBAL_CONST unsigned short ERR_BRDKVIIMG_SRC_LEN_IS_ZERO;
 _GLOBAL_CONST unsigned short ERR_BRDKVIIMG_JPG_ENCODING_ERR;
 _GLOBAL_CONST unsigned short ERR_BRDKVIIMG_JPG_DECODING_ERR;
 _GLOBAL_CONST unsigned short ERR_BRDKVIIMG_MAX_LEN_IS_ZERO;
 _GLOBAL_CONST unsigned short ERR_BRDKVIIMG_PSRC_IS_ZERO;
 _GLOBAL_CONST unsigned short ERR_BRDKVIIMG_CHANNELS_IS_ZERO;
 _GLOBAL_CONST unsigned short ERR_BRDKVIIMG_HEIGHT_IS_ZERO;
 _GLOBAL_CONST unsigned short ERR_BRDKVIIMG_WIDHT_IS_ZERO;
...
typedef struct brdkViImg_JpgEncode
{
	/* VAR_INPUT (analog) */
	unsigned long pSrc;
	signed short width;
...
_BUR_PUBLIC void brdkViImg_JpgEncode(struct brdkViImg_JpgEncode* inst);
...
_BUR_PUBLIC plcbit brdkViImg_setPixel(signed short x, signed short y, unsigned long width, unsigned char* pSrc, unsigned char color);
