...
#define _brdkViGeom_VERSION 1.00.3
#endif
...
_BUR_PUBLIC plcbit brdkViGeom_drawCalibration(double P[3][4], double axsisLength, struct brdkViBase_3d_typ* spotPos, unsigned char numSpot, double spotSize, unsigned long pStr, unsigned long pArgsHole, unsigned long pArgsAxis);
